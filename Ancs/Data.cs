...
namespace SteamVR_Notifier.Ancs
{
    ...
    public class PlainNotification
    {
        ...
        public bool Positive => EventFlags != null && EventFlags.Value.HasFlag(Ancs.EventFlags.EventFlagPositiveAction);

        public bool Negative => EventFlags != null && EventFlags.Value.HasFlag(Ancs.EventFlags.EventFlagNegativeAction);
    }
